    ...
    <div id="dataFormDiv" style="padding-bottom: 100px">
      <ValidationObserver v-slot="observer">
        ...
        <div v-if="step == 5">
          ...
          <div class="row">
            <div class="col">
              Importo iva esclusa: {{ valueSelectedServices.price }}
            </div>
            <div class="col">Importo iva: {{ valueSelectedServices.vat }}</div>
            <div class="col">
              Importo totale: {{ valueSelectedServices.total }}
            </div>
          </div>
        </div>
        ...
        <div v-if="step == 8">
          <div class="row">
            <div class="col">
              <q-btn v-on:click="pagePdf--"> Pg. prec. </q-btn>
              <q-btn v-on:click="pagePdf++"> Pg. succ. </q-btn>
            </div>
          </div>
          <div class="row">
            <div class="col">
