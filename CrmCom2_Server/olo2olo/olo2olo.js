...
const xmlDonatingMigrationNotify = require("fs").readFileSync(
  process.cwd() + "/data/wsdl/DonatingMigrationNotify_rev1.wsdl",
  "utf8"
);
const xmlDonatingMigrationService = require("fs").readFileSync(
  process.cwd() + "/data/wsdl/DonatingMigrationService_rev1.wsdl",
  "utf8"
);
const xmlRecipientMigrationNotify = require("fs").readFileSync(
  process.cwd() + "/data/wsdl/RecipientMigrationNotify_rev1.wsdl",
  "utf8"
);
const xmlRecipientMigrationService = require("fs").readFileSync(
  process.cwd() + "/data/wsdl/RecipientMigrationService_rev1.wsdl",
  "utf8"
);
